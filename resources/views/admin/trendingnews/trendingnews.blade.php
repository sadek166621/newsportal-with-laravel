                            ...
                            @foreach($trendingnewss as $trendingnews)
                                <tr>
                                    ...
                                    <td style="width: 25px">
                                        ...
                                        @endif
                                        <a href="{{route('edit-trending-news',['id'=>$trendingnews->id])}}"class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary"style="position: relative;left: 33px;height: 315px;width: 500px;border: 2px solid #3c8dbc;">
                                ...
                                <!-- form start -->
                                <form style="position: relative; left: 149px" method="post" action="{{route('add-trending-news')}}" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="box-body" style="position: relative;top: 7px;right: 150px;">
                                        <div class="form-group" style="position: relative;top: 66px;">
                                            ...
                                            <input name="trending_news" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Name" style="height: 45px;width: 480px;">
                                        </div>
